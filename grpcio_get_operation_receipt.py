...
make_top_up_response: MakeTopUpOperationResponse = (
    operations_gateway_service.MakeTopUpOperation(make_top_up_request)
)
...
# -------------------------------
# 4. Get operation receipt
# -------------------------------
get_receipt_request = GetOperationReceiptRequest(
    operation_id=make_top_up_response.operation.id
)

get_receipt_response: GetOperationReceiptResponse = (
    operations_gateway_service.GetOperationReceipt(get_receipt_request)
)
